  ...
  return (
    <div className="bg-gradient-to-br from-indigo-600 to-violet-600 rounded-[24px] p-6 text-white shadow-xl shadow-indigo-500/20 relative overflow-hidden h-full flex flex-col justify-between group">
         ...
         <div className="relative z-10 mt-6 space-y-2">
             <button className="w-full text-left px-4 py-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-xl text-xs font-semibold text-white border border-white/10 transition-all flex items-center justify-between group/btn">
